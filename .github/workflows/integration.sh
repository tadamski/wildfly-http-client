...
mvn -B -ntp package -DspecificModule=prepare --batch-mode -Dhttp.client.repository=https://github.com/${EJB_CLIENT_REPOSITORY} -Dhttp.client.branch=${EJB_CLIENT_BRANCH}
